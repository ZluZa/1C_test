...
public class SuperTextMesh : MonoBehaviour, ILayoutElement { //MaskableGraphic... rip
	...
	private static Transform MakeObjectFromAssetPath(MenuCommand menuCommand, string assetName)
	{
		//Create a game object
	   	GameObject objectFab = (GameObject)AssetDatabase.LoadAssetAtPath(STMCustomInspectorTools.ClavianPath + "Assets/ThirdPartyAssets/SuperTextMesh/Resources/STMPrefabs/" + assetName + ".prefab", typeof(GameObject));
...
Vector3 JitterValue_MyJit = Vector3.zero;
	...
	*/
	...
	{
		if(((Component) this).gameObject.activeInHierarchy && uiMode) Rebuild(currentReadTime, currentReadTime > 0f ? true : autoRead);
	}
